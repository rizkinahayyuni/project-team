            ...
            <div class="card-header">
                <div class="container-fluid">
                    <div class="card-title">
                        <a href="{{ route('users.create') }}" class="btn btn-outline-primary btn-block"><i
                        ...
                        <form class="float-right form-inline" id="searchForm" method="get"
                            ...
                            <div class="form-group">
                                <input type="text" name="keyword" class="form-control" id="Keyword"
                                    aria-describedby="Keyword" placeholder="Search users..."
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <form action="{{ route('users.destroy', $data->id) }}" class="pull-left"
                                        method="post">
                                        <a>
                                            @csrf
                                            @method('DELETE')
